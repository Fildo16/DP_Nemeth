...
fig.suptitle("Učenie s plným datasetom obrazov áut a motoriek", fontsize=font_maintitle)
plt.tight_layout()
plt.show()
...
for seed in seeds:
    ...
    file_name_1 = f"decreasing_CB_50_{seed}"
    file_name_2 = f"decreasing_CB_50_{seed}"
    file_name_3 = f"decreasing_CB_50_{seed}"
...
for seed in seeds:
    # Construct the file name
    file_name_1 = f"decreasing_CB_50_{seed}_resnet50"
    file_name_2 = f"decreasing_CB_50_{seed}_resnet50"
    file_name_3 = f"decreasing_CB_50_{seed}_resnet50"
    
    file_name_4 = f"decreasing_CB_50_{seed}_resnet152"
    file_name_5 = f"decreasing_CB_50_{seed}_resnet152"
    file_name_6 = f"decreasing_CB_50_{seed}_resnet152"
...
fig.suptitle("Dataset áut a motoriek - Porovnanie architektúr ResNet", fontsize=font_maintitle)
plt.tight_layout()
plt.show()
...
for seed in seeds:
    # Construct the file name
    file_name_1 = f"DA_online_CB_{seed}"
    file_name_2 = f"DA_online_CB_{seed}"
    file_name_3 = f"DA_online_CB_{seed}"
...
fig.suptitle("Dataset áut a motoriek - Dátová augmentácia online", fontsize=font_maintitle)
plt.tight_layout()
plt.show()
...
for seed in seeds:
    # Construct the file name
    file_name_1 = f"DA_offline_CB_{seed}"
    file_name_2 = f"DA_offline_CB_{seed}"
    file_name_3 = f"DA_offline_CB_{seed}"
...
fig.suptitle("Dataset áut a motoriek - Dátová augmentácia offline", fontsize=font_maintitle)
plt.tight_layout()
plt.show()
...
for seed in seeds:
    # Construct the file name
    file_name_1 = f"NST_CB_{seed}"
    file_name_2 = f"NST_CB_{seed}"
    file_name_3 = f"NST_CB_{seed}"
    file_name_4 = f"NST_CB_{seed}_phase2"
    file_name_5 = f"NST_CB_{seed}_phase2"
    file_name_6 = f"NST_CB_{seed}_phase2"
...
fig.suptitle("Dataset áut a motoriek - NST", fontsize=font_maintitle)
plt.tight_layout()
plt.show()
...
for seed in seeds:
    # Construct the file name
    file_name_1 = f"TL_CB_{seed}"
    file_name_2 = f"TL_CB_{seed}"
    file_name_3 = f"TL_CB_{seed}"
...
fig.suptitle("Dataset áut a motoriek - Transferové učenie", fontsize=font_maintitle)
plt.tight_layout()
plt.show()
...
fig.suptitle("Dataset áut a motoriek", fontsize=font_maintitle)
